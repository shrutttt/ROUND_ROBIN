...
public class RR {
	...
	public static void main(String[] args) {
		Log.printLine("========= Enhanced Round Robin Task Scheduling Algorithm Implementation ========");
		...
		try {
			...
			vmlist = createVM(brokerId,1); //creating 1 vms
			cloudletList = createCloudlet(brokerId,30); // creating 30 cloudlets
			...
			Log.printLine("Enhanced Round Robin has finished executing!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
